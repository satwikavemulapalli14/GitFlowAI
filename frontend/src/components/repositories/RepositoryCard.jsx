...
export default function RepositoryCard({ repo }) {
  return (
    <div className="group rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition-all hover:shadow-md hover:border-primary-200">
      {/* Top row: icon + name */}
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <a
            ...
            className="font-semibold text-primary-600 hover:text-primary-700 truncate block"
          >
